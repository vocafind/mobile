...
class _TabProyekState extends State<TabProyek> {
  ...
  void _showAddEditModal({Map<String, dynamic>? data, bool isEdit = false}) {
    if (data != null) {
      _namaProyekController.text = data['namaProyek'] ?? '';
      _klienController.text = data['klien'] ?? '';
      _peranTimController.text = data['peranTim'] ?? '';
      _penggunaanTeknologiController.text = data['penggunaanTeknologi'] ?? '';
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                        controller: _peranTimController,
                        label: 'Peran Tim',
                      ...
                      _buildTextField(
                        controller: _penggunaanTeknologiController,
  ...
  void _showDeleteConfirmation(Map<String, dynamic> data) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Apakah Anda yakin ingin menghapus proyek ${data['namaProyek']}?',
          style: const TextStyle(
            fontSize: 14,
            fontFamily: 'Poppins',
            color: Color(0xFF515151),
        ...
        children: [
          ...
          _buildProyekItem(
            ...
            onEdit: () {
              _showAddEditModal(
                data: {
                  'namaProyek': 'Sistem Keuangan Negara',
                  'klien': 'Negara Uruguay',
                  'tanggalMulai': DateTime(2023, 1, 1),
                  'tanggalSelesai': DateTime(2023, 1, 2),
                  'peranTim': 'Berperan dalam pembangunan sistem keuangan negara uruguay, dengan membangun sistem keuangan uruguay',
                  'penggunaanTeknologi': 'Teknologi AI',
                },
                isEdit: true,
              );
            },
