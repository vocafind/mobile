...
class DetailLamaranJobfair extends StatefulWidget {
  ...
  const DetailLamaranJobfair({super.key, required this.lamaran});
  ...
  static void show(BuildContext context, {required LamaranSaya lamaran}) {
    showModalBottomSheet(
      ...
      builder: (context) => Builder(
        builder: (bottomSheetContext) => DetailLamaranJobfair(lamaran: lamaran),
      ),
    );
  }

  @override
  State<DetailLamaranJobfair> createState() => _DetailLamaranJobfairState();
}

class _DetailLamaranJobfairState extends State<DetailLamaranJobfair> {
